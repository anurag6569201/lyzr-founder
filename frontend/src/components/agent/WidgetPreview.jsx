...
const WidgetPreview = ({ settings }) => {
  ...
  return (
    <Card className="h-full flex flex-col min-h-[70vh] shadow-lg sticky top-8">
        ...
        <CardContent className="flex-grow bg-muted/30 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className={`absolute ${positionClasses} w-80 h-[28rem] bg-background rounded-xl shadow-2xl flex flex-col border transition-all duration-300`}>
                ...
                <div className="flex-grow p-4 space-y-3 overflow-y-auto">
                    ...
                    <div className="flex items-start gap-2">
                        <div 
                            ...
                            style={{ backgroundColor: settings.theme_color + '20' }} // 20 for ~12% opacity
                        >
                            <Bot className="h-4 w-4" style={{ color: settings.theme_color }} />
                        </div>
             ...
             {/* The Launcher Icon */}
            <div className={`absolute ${positionClasses} w-14 h-14 rounded-full flex items-center justify-center shadow-lg cursor-pointer`} style={{ backgroundColor: settings.theme_color }}>
