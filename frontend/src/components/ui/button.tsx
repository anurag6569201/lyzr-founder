  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground shadow-card hover:shadow-elegant transition-all duration-300",
        secondary:
        ...
        gradient: "bg-gradient-primary text-primary-foreground hover:shadow-glow shadow-elegant transition-all duration-300 hover:scale-105",
        ...
        premium: "bg-gradient-card border border-primary/20 text-foreground hover:shadow-glow shadow-elegant backdrop-blur-sm transition-all duration-300 hover:scale-105",
      },
      size: {
